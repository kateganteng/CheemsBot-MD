 ...
 reply(`Pilih Antilink On / Off `)
		...
		for (let yoi of anu) {
		    ...
		    let btn = [{
                                urlButton: {
                                    displayText: 'Script🔖',
                                    url: 'https://github.com/kateganteng/CheemsBot-MD'
                                }
                            }, {
                                quickReplyButton: {
                                    displayText: '👤Owner👤',
	    ...
	    case 'anonymous': {
				...
				let buttons = [{
                                urlButton: {
                                    ...
                                    url: 'https://wa.me/6282210190420?text=hello+bro+i+found+a+bug+in+your+bot'
                                }
                            }, {
                                quickReplyButton: {
                    ...
                    templateMessage: {
                        hydratedTemplate: {
                            ...
                            hydratedButtons: [{
                                urlButton: {
                                    displayText: 'YouTube📍',
                                    url: 'https:/)youtube.com/c/KATEARRAWAWAWIE'
                                }
                            }, {
                                quickReplyButton: {
                                    displayText: '👤Owner👤',
